...
class ChangeTextTest {
    ...
    fun testChangeToEmptyText() {
        ...
        val sourceText = device.findObject(By.res(packageName, "textToBeChanged")).text
        device.findObject(By.res(packageName, "userInput")).text = textToEmptySet
        device.findObject(By.res(packageName, "buttonChange")).click()
